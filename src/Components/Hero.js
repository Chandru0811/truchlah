...
function Section1() {
  const navigateToGooglePlayStore = () => {
    window.open('https://play.google.com/store/apps/details?id=com.ecscloudinfotech.trucklah', '_blank');
  };
  return (
    <section id="Hero">
            ...
            <div data-aos="fade-right">
              ...
              <div className="row d-flex align-items-center justify-content-center">
                <div className="col-lg-5 col-6 py-2 text-center">
                  <button className="btn btn-primary" id="HeroBtn" onClick={navigateToGooglePlayStore}>
                    Dowload App
                  </button>
                </div>
