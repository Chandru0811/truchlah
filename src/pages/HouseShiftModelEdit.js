...
function HouseShiftModelEdit({
  ...
  console.log("selectedLocationDetails Edit:",selectedLocationDetails);
      ...
      let titles =
        title === "Pick Up Location"
          ...
          : title === "Drop Location"
            ...
            : `stop${title}`;
      values.state = titles;
      console.log("Location Edit Details:", values);
      selectedLocationDetails((prevDetails) => {
...
export default HouseShiftModelEdit;
