        ...
        if (response.status === 200) {
          ...
          const transformBookingLocations = (locations) => {
            ...
            result.push({
              ...
              noOfBedrooms: firstLocation.pickupNoOfBedrooms,
            ...
            result.push({
              ...
              noOfBedrooms: lastLocation.dropoffNoOfBedrooms,
            ...
            for (let i = 0; i < locations.length - 1; i++) {
              ...
              result.push({
                ...
                typeOfProperty: location.dropoffTypeOfProperty,
                noOfBedrooms: location.dropoffNoOfBedrooms,
                propertyFloor: location.dropoffPropertyFloor,
                propertyDescription: location.dropoffPropertyDescription,
                isElevator: location.dropoffIsElevator,
