          ...
          <div className="row align-items-center justify-content-between ">
            <div className="col">
              <div className="d-flex align-items-center gap-4">
                <h1 className="h4 ls-tight headingColor ">House Category Management</h1>
              </div>
            </div>
            <div className="col-auto">
              <div className="hstack gap-2 justify-content-end">
                <Link to="/housecategorymanagement/add">
              ...
              {/* {datas.map((data, index) => ( */}
                <tr>
                  ...
                  <td className="text-center">
                    <div className="gap-2">
                      <Link to={`/housecategorymanagement/view/`}>
                        <button className="btn btn-light btn-sm  shadow-none border-none">
                          View
                        </button>
                      </Link>
                      <Link to={`/housecategorymanagement/edit/`} className="px-2">
                        <button className="btn btn-light  btn-sm shadow-none border-none">
                          Edit
                        </button>
                      </Link>
...
export default HouseCategoryManagement;
