...
function VehicleManagementEdit() {
  ...
  const validationSchema = Yup.object({
    ...
    securedZoneCharge: Yup.number().required("*Secured zone charge is required"),
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      console.log(values);
      try {
        const response = await driverApi.put(`/vehicle/vehicleType/Update/${id}`,
          values,
        );
        ...
        <div className="card shadow minHeight border-0 my-2">
          <div className="container mb-5">
            <div className="row py-4">
              ...
              <div className="col-md-6 col-12 mb-2">
                ...
                <div className="mb-3">
                  <input
                    type="number"
                    name="tailGateCharge"
                    className={`form-control ${formik.touched.tailGateCharge && formik.errors.tailGateCharge
                      ? "is-invalid"
                      : ""
                      }`}
                    {...formik.getFieldProps("tailGateCharge")}
                  />
                  {formik.touched.tailGateCharge && formik.errors.tailGateCharge && (
                    <div className="invalid-feedback">
              ...
              <div className="col-md-6 col-12 mb-2">
                ...
                <div className="mb-3">
                  <input
                    type="number"
                    name="overtimeCharge"
                    className={`form-control ${formik.touched.overtimeCharge && formik.errors.overtimeCharge
                      ? "is-invalid"
                      : ""
                      }`}
                    {...formik.getFieldProps("overtimeCharge")}
                  />
                  {formik.touched.overtimeCharge && formik.errors.overtimeCharge && (
                    <div className="invalid-feedback">
              ...
              <div className="col-md-6 col-12 mb-2">
                <label className="form-label mb-0">
                  Non-lift Access Charge <span className="text-danger">*</span>
                </label>
                <div className="mb-3">
                  <input
                    type="number"
                    name="nonLiftAccess"
                    className={`form-control ${formik.touched.nonLiftAccess && formik.errors.nonLiftAccess
                      ? "is-invalid"
                      : ""
                      }`}
                    {...formik.getFieldProps("nonLiftAccess")}
                  />
                  {formik.touched.nonLiftAccess && formik.errors.nonLiftAccess && (
                    <div className="invalid-feedback">
              ...
              <div className="col-md-6 col-12 mb-2">
                ...
                <div className="mb-3">
                  <input
                    ...
                    className={`form-control ${formik.touched.securedZoneCharge && formik.errors.securedZoneCharge
                      ? "is-invalid"
                      : ""
                      }`}
                    {...formik.getFieldProps("securedZoneCharge")}
                  />
                  {formik.touched.securedZoneCharge && formik.errors.securedZoneCharge && (
                    <div className="invalid-feedback">
              ...
              <div className="col-md-6 col-12 mb-2">
                ...
                <div className="mb-3">
                  <input
                    type="number"
                    name="wrappingCharge"
                    className={`form-control ${formik.touched.wrappingCharge && formik.errors.wrappingCharge
                      ? "is-invalid"
                      : ""
                      }`}
                    {...formik.getFieldProps("wrappingCharge")}
                  />
                  {formik.touched.wrappingCharge && formik.errors.wrappingCharge && (
                    <div className="invalid-feedback">
              ...
              <div className="col-md-6 col-12 mb-2">
                ...
                <div className="mb-3">
                  <input
                    type="number"
                    name="addStopCharge"
                    className={`form-control ${formik.touched.addStopCharge && formik.errors.addStopCharge
                      ? "is-invalid"
                      : ""
                      }`}
                    {...formik.getFieldProps("addStopCharge")}
                  />
                  {formik.touched.addStopCharge && formik.errors.addStopCharge && (
                    <div className="invalid-feedback">
              ...
              <div className="col-md-6 col-12 mb-2">
                ...
                <div className="mb-3">
                  <input
                    ...
                    className={`form-control ${formik.touched.tenToTwelveCharge && formik.errors.tenToTwelveCharge
                      ? "is-invalid"
                      : ""
                      }`}
                    {...formik.getFieldProps("tenToTwelveCharge")}
                  />
                  {formik.touched.tenToTwelveCharge && formik.errors.tenToTwelveCharge && (
                    <div className="invalid-feedback">
              ...
              <div className="col-md-6 col-12 mb-2">
                ...
                <div className="mb-3">
                  <input
                    ...
                    className={`form-control ${formik.touched.twelveToSevenCharge && formik.errors.twelveToSevenCharge
                      ? "is-invalid"
                      : ""
                      }`}
                    {...formik.getFieldProps("twelveToSevenCharge")}
                  />
                  {formik.touched.twelveToSevenCharge && formik.errors.twelveToSevenCharge && (
                    <div className="invalid-feedback">
              ...
              <div className="col-md-6 col-12 mb-2">
                ...
                <div className="mb-3">
                  <input
                    type="number"
                    name="peakHourCharge"
                    className={`form-control ${formik.touched.peakHourCharge && formik.errors.peakHourCharge
                      ? "is-invalid"
                      : ""
                      }`}
                    {...formik.getFieldProps("peakHourCharge")}
                  />
                  {formik.touched.peakHourCharge && formik.errors.peakHourCharge && (
                    <div className="invalid-feedback">
